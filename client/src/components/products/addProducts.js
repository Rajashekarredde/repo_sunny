...
function addProducts({ setShowProductsAddPage })
{
  ...
  {
    const itemImage = event.target.files[0]
  ...
  const addItem = (e) =>
  {
    ...
    console.log( "sunn id-> " + user.id);

    Axios.post("/addProduct/" + user.id, formData, {
  ...
  return(
    <div className="bg-modal">
      ...
      >
        ...
        <h2 className="addProd_title">Enter The Details</h2>
        <form
        ...
        >
          ...
          <div className="htmlForm-group">
           ...
           <div className="htmlForm-group">
            <label htmlFor="item_des">information</label>
            <br />
            <input
              type="text"
              className="item_des"
          ...
          <div className="htmlForm-group">
            <label htmlFor="item_count">Stock</label>
            <br />
            <input
              type="number"
